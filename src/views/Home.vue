  ...
  <div class="home">
    ...
    <div class="right" id="right-wrapper">
      ...
      <Select v-model="baseUrl" style="width:100%;marginTop:10px;">
        <Option v-for="(item, index) in list" :value="item.url" :key="index">{{
          item.name
        }}</Option>
      </Select>
...
export default {
  ...
  data() {
    return {
      ...
      list: [
        { name: "接口1（推荐）", url: "https://cdn.yangju.vip/k/?url=" },
        { name: "接口2", url: "https://api.bbbbbb.me/jx/?url=" },
        { name: "接口3", url: "https://vip.hackmg.com/jx/index.php?url=" }
      ]
    };
  },
  computed: {},
